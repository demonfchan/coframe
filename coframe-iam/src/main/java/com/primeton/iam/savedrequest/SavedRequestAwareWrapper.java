 ...
 * All rights reserved.
 *
 * Created on 2018年07月10日 17:57:18
 ******************************************************************************/
...
class SavedRequestAwareWrapper extends HttpServletRequestWrapper {
	...
	/**
	 * The set of SimpleDateFormat formats to use in getDateHeader(). Notice that
	 * because SimpleDateFormat is not thread-safe, we can't declare formats[] as a
	 * static variable.
	 */
	...
	/**
	 * If the parameter is available from the wrapped request then the request has
	 * been forwarded/included to a URL with parameters, either supplementing or
	 * overriding the saved request values.
	 * <p>
